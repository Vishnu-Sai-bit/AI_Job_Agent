...
from services.learning_engine import generate_learning_roadmap
from services.salary_predictor import predict_salary
from services.linkedin_optimizer import optimize_linkedin_profile
from services.email_generator import generate_job_emails
from services.report_generator import generate_profile_report
...
async def optimize_uploaded_resume(
    ...
    try:
        ...
        if not target_role:
            from services.resume_enricher import infer_role
